...
요청 예시:
- `https://qbvq3zqekb.execute-api.ap-northeast-2.amazonaws.com/api/hospitals/1`
...
요청 예시:
`DELETE https://qbvq3zqekb.execute-api.ap-northeast-2.amazonaws.com/api/favorites/1`
`X-User-Name: hyunseo`
