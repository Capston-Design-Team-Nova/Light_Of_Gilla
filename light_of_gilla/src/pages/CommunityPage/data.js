...
export const posts = [
    {
      ...
      comments: [
        { id: 1, writer: "내과의사 철수", text: "아 그럴때는 일단 맨발로 한시간동안 걸어보고 물을 충분히 섭취하세요. 계속 해결이 안된다면 병원을 찾아주십시오." },
        { id: 2, writer: "영희", text: "러닝을 해보세요!" },
      ],
      likes: 5,
    ...
    },
    {
      ...
      comments: [{ id: 1, writer: "이준맘", text: "아이구..얼른 소아과나 응급실 가보셔요" }],
      likes: 8,
